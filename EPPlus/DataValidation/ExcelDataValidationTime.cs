...
namespace OfficeOpenXml.DataValidation
{
    ...
    public class ExcelDataValidationTime : ExcelDataValidationWithFormula2<IExcelDataValidationFormulaTime>, IExcelDataValidationTime
    {
        ...
        public ExcelDataValidationTime(ExcelWorksheet worksheet, string address, ExcelDataValidationType validationType)
        ...
        public ExcelDataValidationTime(ExcelWorksheet worksheet, string address, ExcelDataValidationType validationType, XmlNode itemElementNode)
