...
namespace OfficeOpenXml.Drawing.Chart
{
    ...
    public class ExcelChartSeries : XmlHelper, IEnumerable
    {
            ...
            : base(ns, node)
        {
            ...
            {
                var s = chart.ChartNode.LocalName switch
                {
                    "scatterChart" => new ExcelScatterChartSerie(this, ns, n, isPivot),
                    "lineChart" => new ExcelLineChartSerie(this, ns, n, isPivot),
                    "pieChart" or "ofPieChart" or "pie3DChart" or "doughnutChart" => new ExcelPieChartSerie(this, ns, n,
                        isPivot),
                    "bubbleChart" => new ExcelBubbleChartSerie(this, ns, n, isPivot),
                    _ => new ExcelChartSerie(this, ns, n, isPivot)
                };
                _list.Add(s);
            }
        }
        ...
        {
            if (chartType is eChartType.Line or eChartType.LineStacked or eChartType.LineStacked100
                or eChartType.XYScatterLines or eChartType.XYScatterSmooth or eChartType.XYScatterLinesNoMarkers
                or eChartType.XYScatterSmoothNoMarkers)
            {
        ...
        {
            if (chartType is eChartType.XYScatter or eChartType.XYScatterLines or eChartType.XYScatterLinesNoMarkers
                or eChartType.XYScatterSmooth or eChartType.XYScatterSmoothNoMarkers or eChartType.Bubble
                or eChartType.Bubble3DEffect)
            {
        ...
        {
            if (chartType is eChartType.PieExploded3D or eChartType.PieExploded or eChartType.DoughnutExploded)
            {
        ...
        {
            if (chartType is eChartType.XYScatterSmooth or eChartType.XYScatterSmoothNoMarkers)
            {
