        ...
        private ExcelDxfColor GetColor(XmlHelperInstance helper, string path)
        {
            ...
            if (rgb!="")
            {
                ret.Color = new SKColor((byte)int.Parse(rgb.Substring(0, 2), NumberStyles.AllowHexSpecifier),
                                            (byte)int.Parse(rgb.Substring(2, 2), NumberStyles.AllowHexSpecifier),
                                            (byte)int.Parse(rgb.Substring(4, 2), NumberStyles.AllowHexSpecifier),
                                            (byte)int.Parse(rgb.Substring(6, 2), NumberStyles.AllowHexSpecifier));
            }
