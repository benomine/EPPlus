...
namespace EPPlusTest
{
    ...
    public class ConditionalFormatting
    {
        ...
        public void TwoBackColor()
        {
            ...
            condition1.Style.Fill.BackgroundColor.Color = SKColors.Green;
            ...
            condition2.Style.Fill.BackgroundColor.Color = SKColors.Red;
        }
        [TestMethod]
        public void Databar()
        {
            var ws = _pck.Workbook.Worksheets.Add("Databar");
            var cf = ws.ConditionalFormatting.AddDatabar(ws.Cells["A1:A5"], SKColors.BlueViolet);
            ws.SetValue(1, 1, 1);
            ws.SetValue(2, 1, 2);
            ws.SetValue(3, 1, 3);
            ws.SetValue(4, 1, 4);
